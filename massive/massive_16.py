...
pool_dir = working_dir + 'pools_16/'
obs_dir = working_dir + 'obs_ids/'
trackfilename = working_dir + "RedLeakMultiObs_16.txt"
...
def run_massive(csv_file):
    ...
    for i in range(len(obs_list)):
        ...
        try:
            ...
            compress(inputpath=pool_dir + obs_number,
                     archive=pool_dir + obs_number + ".tgz",
                     compression="TGZ")
        ...
        try:
            print 'Compressing file for struct observation: ', obs_number
            compress(inputpath=pool_dir + "Export/" + obs_number,
                     archive=pool_dir + obs_number + "_struct.tgz",
                     compression="TGZ")
